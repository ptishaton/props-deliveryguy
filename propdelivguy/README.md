...
- propdelivguy-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- propdelivguy-ui: main application module, development time
- propdelivguy-production: module that produces a production mode WAR for deployment
